...
public class Main_Frame extends JFrame{
	...
	private JLabel lp1;					// Label indicador de Player1
	private JLabel lp2;					// Label indicador de Player2
	...
	private JLabel lsplayers;			// Label indicador de jugador
	private JComboBox<String> cPlayers; // ComboBox cantidad de jugadores
	private JLabel llvlvalue;			// Label con el valor del nivel
	private JLabel lspdvalue;			// Label con el valor de la velocidad
	private JPanel pp12;				// Panel indicador de seleccion de jugadores
	...
	// clase que genera y maneja la ventana net Server
	class cWindow extends JFrame{
		...
		cWindow(){
		    ...
		    //Título
		    setTitle("Server Network configuration");
			...
			lPort.setBorder(new CompoundBorder(
			...
			// Action del boton Aceptar del net config
	    ...
	    public void run() {
			...
			while(gamestate==true) {
				 ...
				 if(dw1.getFlagST() == 1) {
					 ...
					 openFile();
					 if(flagSP == 2) {
						 dw1.setStime(sTotalTime);
						 while(dw1.socketFinishedServer()!=0);
					 }else {
	...
	private void initConfig() {
		setTitle("ARKANOID Torravi 3000 turbo edition - Server");
		setSize(900,700);
		setResizable(false);
